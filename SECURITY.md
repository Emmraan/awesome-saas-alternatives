...
- This project has no secrets in the repository; environment variables are
  loaded via `.env` files (git-ignored) or CI secrets.
- GitHub star/license/release metadata is only ever filled from the GitHub API,
  never hard-coded.
